...
export const en: Translation = {
	...
	[Key.tools]: "Tools",
	[Key.toolsSubtitle]: "Collect frequently used sites and tools",
	[Key.toolsSearchPlaceholder]: "Search tool name or description...",
	[Key.toolsFilterAll]: "All",
	[Key.toolsNoResults]: "No matching tools found",
	[Key.aboutMe]: "About Me",
	[Key.aboutSite]: "About This Site",
	...
	[Key.siteStatsHoursAgo]: "{hours} hours ago",
	...
	[Key.footprintsSubtitle]:
		"Open the world map to see the countries, provinces, and cities I have visited",
	[Key.footprintsEmpty]: "No footprints have been added yet",
	[Key.footprintsMapHint]:
		"Zoom the map freely, then click a marker or a place card below to view the exact location",
	[Key.footprintsVisitedDate]: "Visited:",
};
