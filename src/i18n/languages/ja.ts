...
export const ja: Translation = {
	...
	[Key.friendsTags]: "タグ",
	[Key.tools]: "便利ツール",
	[Key.toolsSubtitle]: "よく使うサイトとツールをまとめています",
	[Key.toolsSearchPlaceholder]: "ツール名や説明を検索...",
	[Key.toolsFilterAll]: "すべて",
	[Key.toolsNoResults]: "一致するツールが見つかりません",
	[Key.untitled]: "無題",
	...
	[Key.siteStatsHoursAgo]: "{hours}時間前",
	...
	[Key.aboutMe]: "私について",
	[Key.aboutSite]: "このサイトについて",
	[Key.footprints]: "足跡",
	[Key.footprintsSubtitle]:
		"訪れた国・都道府県・都市を世界地図で確認できます",
	[Key.footprintsEmpty]: "まだ足跡はありません",
	[Key.footprintsMapHint]:
		"地図は拡大縮小できます。マーカーまたは下の場所カードをクリックすると詳細を確認できます",
	[Key.footprintsVisitedDate]: "訪問日:",
};
