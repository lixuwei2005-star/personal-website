...
export const zh_CN: Translation = {
	...
	[Key.friendsTags]: "标签",
	[Key.tools]: "实用工具",
	[Key.toolsSubtitle]: "收录常用网站与工具",
	[Key.toolsSearchPlaceholder]: "搜索工具名称或描述...",
	[Key.toolsFilterAll]: "全部",
	[Key.toolsNoResults]: "未找到匹配的实用工具",
	[Key.untitled]: "无标题",
	...
	[Key.siteStatsHoursAgo]: "{hours} 小时前",
	...
	[Key.aboutSite]: "关于本站",
	[Key.footprints]: "足迹",
	[Key.footprintsSubtitle]: "在世界地图上查看我去过的国家、省份和城市",
	[Key.footprintsEmpty]: "还没有添加任何足迹",
	[Key.footprintsMapHint]:
		"地图支持缩放，点击标记或下方地点卡片即可查看具体位置",
	[Key.footprintsVisitedDate]: "到访：",
};
