...
export const zh_TW: Translation = {
	...
	[Key.friendsTags]: "標籤",
	[Key.tools]: "實用工具",
	[Key.toolsSubtitle]: "收錄常用網站與工具",
	[Key.toolsSearchPlaceholder]: "搜尋工具名稱或描述...",
	[Key.toolsFilterAll]: "全部",
	[Key.toolsNoResults]: "未找到匹配的實用工具",
	[Key.untitled]: "無標題",
	...
	[Key.siteStatsHoursAgo]: "{hours} 小時前",
	...
	[Key.aboutSite]: "關於本站",
	[Key.footprints]: "足跡",
	[Key.footprintsSubtitle]: "在世界地圖上查看我去過的國家、省份和城市",
	[Key.footprintsEmpty]: "還沒有新增任何足跡",
	[Key.footprintsMapHint]:
		"地圖支援縮放，點擊標記或下方地點卡片即可查看具體位置",
	[Key.footprintsVisitedDate]: "到訪：",
};
